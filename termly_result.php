...
if (!empty($result_name) || !empty($result_reg_number)) {
    $stmt = $connection->prepare("SELECT * FROM behavioral WHERE name = ? OR reg_number = ?");
    $stmt->bind_param("ss", $result_name, $result_reg_number);
    $stmt->execute();
    $res = $stmt->get_result();
                    ...
                    <?php
                        ...
                        if(mysqli_num_rows($run_query) > 0){
                            ...
                            <div class='row'>
                                <div class='leftcolumn'>
                                    <table class='text-info' id='result'>
                                        <thead>
                                            <th style='text-align:center' colspan='7'><b>COGNITIVE DOMAIN</b></th>
                                            <tr class='info'>
                                                <th>S/N</th>
                                                <th>SUBJECTS</th>
                                                <th style='writing-mode:vertical-rl; text-align:center;'>CA (40)</th>
                                                <th style='writing-mode:vertical-rl; font-size: 9; text-align:center;'>EXAM (60)</th>
                                                <th style='writing-mode:vertical-rl; font-size: 9; text-align:center;'>TOTAL (100)</th>
                                                <th style='writing-mode:vertical-rl; text-align:center;'>POSITION</th>
                            ...
                            while($result = mysqli_fetch_assoc($run_query)){
                                ...
                                $result_ca = $result['ca1'] + $result['ca2'];
                                ...
                                echo"
                                    <tr>
                                        ...
                                        <td style='text-align: center'>{$result_ca}</td>
                                        <td style='text-align: center'>{$result_exam}</td>
                                        <td style='text-align: center'>{$result_score}</td>
                                        <td style='text-align: center'>{$result_rank}</td>
                        ...
                        ?>
                            ...
                            <h6></h6>
                            <table class='text-info' id='result'>
                                    <th style='text-align:center' colspan="5"><b>GRADE SCALE </b></th>					   
                                    <tr>
                                        <td style='text-align:center' ><b>A (80-100)</b></br> <b>EXCELLENT</b></td>
                                        <td style='text-align:center' ><b>B (60-79)</b></br> <b>GOOD</b></td>
                                        <td style='text-align:center' ><b>C (50-59)</b></br> <b>FAIR</b></td>
                                        <td style='text-align:center' ><b>D (40-49)</b></br> <b>BELOW AVERAGE</b></td>
                                        <td style='text-align:center' ><b>F (0-39)</b></br> <b>FAILED</b></td>			
                                    </tr>				
                            </table>
                        ...
                        <?php
                            ...
                            if (mysqli_num_rows($run_query) == 1) {
                                while ($result = mysqli_fetch_assoc($run_query)) {
                                    ...
                                    $student_average = round($student_total / $number_of_subject, 2);
                                    $position_in_class = $result['class_position'];
                                    $ordinal_position = getOrdinal($position_in_class); // Convert to ordinal
                                }
                            }
                        ?>                    
                            <table class='text-info' id='result'>
                                <th style='text-align:center' colspan="5"><b>PERFORMANCE SUMMARY </b></th>					   
                                <tr>
                                    <td style="text-align:center; font-size:10px;"><b>MARKS OBTAINABLE</b></td>
                                    <td style="text-align:center; font-size:10px;"><b>MARKS OBTAINED</b></td>
                                    <td style="text-align:center; font-size:10px;"><b>AVERAGE</b></td>
